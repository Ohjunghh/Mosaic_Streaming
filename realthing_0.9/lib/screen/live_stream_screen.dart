...
class _LiveViewPageState extends State<LiveViewPage> with WidgetsBindingObserver {
  ...
  Future<void> _notifyDjangoBroadcastStarted() async {
    String userEmail = 'aaa@naver.com'; // 실제 사용자 이메일로 변경하세요
    try {
      final response = await http.post(
        Uri.parse('http://172.30.1.26:8000/api/webcam/start_flutter_stream/'),
      ...
      if (response.statusCode == 200) {
        print('Broadcast start notification sent successfully');
      } else {
